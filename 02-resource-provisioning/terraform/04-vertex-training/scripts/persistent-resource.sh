...
create_resource() {
    gcloud ai persistent-resources create \
        ...
        --project=${project_id} \
        --region=${region} \
        --resource-pool-spec="replica-count=3,machine-type=n1-standard-4,disk-type=pd-ssd,disk-size=100"
#        --resource-pool-spec="replica-count=3,machine-type=a2-ultragpu-1g,accelerator-type=NVIDIA_A100_80GB,accelerator-count=1,disk-type=pd-ssd,disk-size=100"
# L4#	--resource-pool-spec="replica-count=3,machine-type=g2-standard-8,accelerator-type=NVIDIA_L4,accelerator-count=1,disk-type=pd-ssd,disk-size=100" \
# test \
